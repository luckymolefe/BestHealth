...
if(isset($_REQUEST['pid'])) {
	$row = $admin->getPatientById($_REQUEST['pid']);
}
...
<body>
	<div class="container-fluid">
		...
		<form action="controller.php" method="POST" enctype="application/x-www-forms-urlencoded">
			<div>
				<input type="text" name="idnumber" readonly="readonly" class="form-control" value="<?php echo $row->idnumber; ?>" placeholder="Enter ID Number">
			</div>
			<div>
			...
			<div>
				<input type="date" name="telephone" class="form-control" value="<?php echo $row->telephone; ?>" placeholder="Enter telephone">
			</div>
			<div>
			...
			<div>
				<button type="button" name="back" class="btn" onclick="router('viewrecords')">&larr; Back</button>
				<button type="submit" name="savedit" value="true" class="btn success"><i class="fa fa-save"></i> Save</button>
			</div>
		</form>
	</div>
</body>
